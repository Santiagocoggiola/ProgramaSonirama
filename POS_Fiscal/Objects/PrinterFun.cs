...
namespace Sonirama
{
    class PrinterFun
    {
        ...
        public static void ConectarConImpresora()
        {
            ...
            //Configuro Puerto
            error = Printer.ConfigurarPuerto("0");
        ...
        public static void CargaComprobante(string factura, string cod)
        {
            ...
            Printer.ConsultarNumeroComprobanteUltimo(cod, sb, 10);
            int comp = int.Parse(sb.ToString()) + 1;
            string comprobante = cod + "00001" + FacturaNro(comp.ToString());
            Printer.CargarComprobanteAsociado(comprobante);
        ...
        public static int GuardarComprobante(string factura)
        {
            ...
            {
                MessageBox.Show("Realice el cierre Z antes de continuar o verifique si esta la maquina conectada");
            }
