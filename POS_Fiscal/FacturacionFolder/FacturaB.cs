...
namespace POS_Fiscal
{
    ...
    public partial class FacturaB : Form
    {
        ...
        private void botonImprimir_Click(object sender, EventArgs e)
        {
            ...
            PrinterFun.CargarCliente(combobox1, combobox2, "Consumidor Final", cliente, 5, 1, ref clienteCargado, "SIN DOCUMENTO");
            ...
            else
            {
                ...
                PrinterFun.ImprimirItems(list, combobox3, interes, cantidadPagos, "FacturaB", cliente);
            }
