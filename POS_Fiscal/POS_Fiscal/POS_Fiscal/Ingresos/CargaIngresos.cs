                ...
                && TxtFecha.Text != "" && TxtDolar.Text != "")
            {
                ...
                for (int i = 0; i < list.Count; ++i)
                {
                    ...
                    if (item.cambioPrecio)
                    {
                        ...
                        Query = "UPDATE stock.stock SET PREPUBCIVA=" + "'" + precioPub + "'" + ", DOLAR=" + "'" + precioList + "'" + ", DOLIS=" + "'" + precioCosto + "'" + ", PRETA=" + "'" + precioTa + "'" + ", CANTID=" + cantidad + ", COSDOL='" + dolar + "', PRETARG='" + precioTarj + "' WHERE CODIGO=" + item.codigo;
                        Helpers.NonQuery(Query, con);
                        con.Close();
                    }
                }
