...
namespace POS_Fiscal
{
    public partial class FacturaA : Form
    {
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            panel1.Controls.Remove(panel1.Controls.Find("txt_nombre" + index, true)[0]);
            panel1.Controls.Remove(panel1.Controls.Find("txt_cantidad" + index, true)[0]);
            panel1.Controls.Remove(panel1.Controls.Find("txt_totalUnitario" + index, true)[0]);
        ...
        private void CargarCliente()
        {
            ...
            {
                if ((helper.Length != 11 && label2.Text == "CUIT") || comboBox2.SelectedItem == null)
                {
        ...
        private void BotonImprimirA_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    PrinterFun.CargaComprobante("FacturaA");
                    ...
                    date = DateTime.Now;
                    rd.Close();
                    /*cmd = new MySqlCommand("INSERT INTO stock.ventasa (IDVENTASA, NROCOMPROBANTE, CUIT, PRECIO, FECHA)" + " VALUES" + '(' + ""  + ',' + cuit + ',' + monto + ',' + date.ToString() , con);
                    cmd.ExecuteNonQuery();
                    con.Close();*/
                    PrinterFun.ImprimirItems(list, combobox3, interes, cantidadPagos, "FacturaA");
